...
CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "photo_gallery_wp_gallerys` (
  ...
  UNIQUE KEY `id` (`id`)
        ...
        $sql_photo_gallery_wp_gallerys_alter = "ALTER TABLE `" . $wpdb->prefix . "photo_gallery_wp_gallerys` ADD `hover_effect` int( 1 ) NOT NULL default 0 after `description`";
...
(1, 'My First Gallery', 375, 600, 'on', 'random', '4000', '1000', 'center', 1, '300', '5')";
        ...
        $wpdb->query($sql_photo_gallery_wp_gallerys_alter);
