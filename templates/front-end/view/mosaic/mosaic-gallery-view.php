<?php
wp_register_script('mosaicflow.js', Photo_Gallery_WP()->plugin_url() . '/assets/albums/js/jquery.mosaicflow.js', array('jquery'), '1.0.0', true);
...
<div id="ph-g-wp-masonry_<?php echo $galleryID; ?>"
    ...
    <div id="mosaic_images_section_1" class="grid ph-gallery-wp-loading-class" style="visibility: hidden">
        <?php
        global $wpdb;
            ...
            <div class="grid-item view  <?= $hover_class; ?>">
                <div class="<?= $hover_class; ?>-wrapper view-wrapper">
                    ...
                    <a href="<?php echo esc_url($row->image_url); ?>" class="ph-lightbox">
                        ...
                        ?>
                        <a href="<?php echo esc_url($row->image_url); ?>" class="ph-lightbox">
                            <img src="http://img.youtube.com/vi/<?php echo esc_html($videourl[0]); ?>/mqdefault.jpg"
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#mosaic_images_section_1").mosaicflow();
    })
</script>
