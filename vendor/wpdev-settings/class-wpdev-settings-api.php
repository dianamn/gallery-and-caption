...
if (!class_exists('WPDEV_Settings_API')):
    class WPDEV_Settings_API
    {
        ...
        protected function control_color($id, $control)
        {
            ...
            echo $label_str;
            ?>
            <input type="text" class="jscolor <?php echo $html_class_str; ?>" <?php echo $placeholder; ?>
                   id="<?php echo $id; ?>" name="wpdev_options[<?php echo $id; ?>]" value="<?php echo $default; ?>"/>
            <?php
                    ...
                    <ul>
                        ...
                        foreach ($control['choices'] as $key => $choice) {
                            ...
                            <li>
                                ...
                                <label for="<?php echo $id . '-' . $key; ?>"><img src="<?php echo $choice; ?>"
                                                                                  width="<?php echo $width; ?>"
                                                                                  height="<?php echo $height; ?>"/></label>
                            </li>
                            <?php
                        }
                        ?>
                    ...
                    <ul>
                        ...
                        foreach ($control['choices'] as $key => $choice) {
                            ...
                            <li>
                                <input type="radio" value="<?php echo $key ?>" <?php checked($default, $key); ?>
                                       id="<?php echo $id . '-' . $key; ?>" name="wpdev_options[<?php echo $id; ?>]"/>
                                <label for="<?php echo $id . '-' . $key; ?>"><span
                                            class="radicon"></span><?php echo $choice; ?></label>
                            </li>
                            <?php
                        }
                        ?>
        ...
        protected function control_select($id, $control)
        {
            ...
            echo $label_str;
            ?>
            <select <?php echo implode(' ', $attrs); ?> class="<?php echo $html_class_str; ?>" id="<?php echo $id; ?>"
                                                        name="wpdev_options[<?php echo $id; ?>]">
                <?php
                if (isset($control['choices']) && !empty($control['choices'])) {
                    foreach ($control['choices'] as $key => $choice) {
                        $attrs = array();
        ...
        protected function control_textarea($id, $control)
        {
            ...
            echo $label_str;
            ?>
            <textarea <?php echo implode(' ', $attrs); ?> class="<?php echo $html_class_str; ?>" id="<?php echo $id; ?>"
                                                          name="wpdev_options[<?php echo $id; ?>]"><?php echo $default; ?></textarea>
            <?php
            echo $description_str;
        }
        ...
        protected function _control_hidden($id, $control)
        {
            $default = (isset($control['default']) ? $control['default'] : "");
            ?>
            <input type="hidden" name="wpdev_options[<?php echo $id; ?>]" id="<?php echo $id; ?>"
                   value="<?php echo $default; ?>"/>
            <?php
        }
        ...
        protected function _control_checkbox($id, $control)
        {
            ...
            <div class="control-container control-container-<?php echo $type . ' ' . implode(' ', $html_class); ?>">
                ...
                <input <?php echo implode(' ', $attrs); ?> type="checkbox" class="<?php echo $html_class_str; ?>"
        ...
        public function single_control($id, $control)
        {
            ...
            if (method_exists($this, '_control_' . $type)) {
                ...
                <div class="control-container control-container-<?php echo $type . ' ' . implode(' ', $html_class); ?>">
                    <?php echo $label_str; ?>
                    <input <?php echo implode(' ', $attrs); ?> type="<?php echo $type; ?>"
                                                               class="<?php echo $html_class_str; ?>" <?php echo $placeholder; ?>
                                                               id="<?php echo $id; ?>"
                                                               name="wpdev_options[<?php echo $id; ?>]"
                                                               value="<?php echo $default; ?>"/>
                    <?php echo $description_str; ?>
        ...
        protected function display()
        {
            ...
            if (!empty($this->controls)) {
                ...
                <div class="wpdev_settings_cluster">
                    <form class="wpdev_settings_form" id="<?php echo $this->form_id; ?>" action=""
                        ...
                        <div class="wpdev-settins-submit-block">
                            ...
                            <input type="hidden" name="wpdev_settings_current_plugin"
        ...
        public function save_options()
        {
            ...
            if (!check_admin_referer('wpdev_settings_save_options', 'wpdev_settings_save_nonce')) {
                ...
                if ($ajax) {
                    echo json_encode(array('errorMsg' => __("Wrong nonce parameter")));
                    die;
                }
            ...
            if (isset($_REQUEST['wpdev_options']) && is_array($_REQUEST['wpdev_options']) && !empty($_REQUEST['wpdev_options'])) {
                ...
                if ($ajax) {
                    echo json_encode(array('successMsg' => __("Saved Successfully")));
                    die;
                }
                return true;
            }
            ...
            if ($ajax) {
                echo json_encode(array('errorMsg' => __("Something went wrong")));
                die;
            }
